...
permalink: /
subtitle: >
  <strong>Incoming Postdoctoral Researcher</strong><br>
  MUSE Lab., Hanyang University
...
### [Human Factors & User Experience]({% link _pages/research.md %}#human-factors-ux)
...
### [Physiological Computing & Human-State Assessment]({% link _pages/research.md %}#physiological-computing)

Using EEG, ECG/HRV, EMG, eye tracking, and subjective measures to characterize human states, responses, and individual differences.

### [Human–AI Interaction]({% link _pages/research.md %}#human-ai-interaction)

Investigating adaptive and explainable AI-enabled systems from a human-centered perspective, with attention to user behavior and response.
...
### [Physiological Assessment of Gaming Disorder]({% link _pages/research.md %}#physiological-computing)

Event-driven EEG, HRV, and machine-learning approaches to human-state assessment.

### [Applied Ergonomics and UX Evaluation]({% link _pages/research.md %}#human-factors-ux)

Human-factors studies involving physical ergonomics, eye tracking, EMG, usability, and product interaction.

### [Human–AI Interaction and Adaptive XAI]({% link _pages/research.md %}#human-ai-interaction)

An emerging research direction focused on adaptive, explainable, and human-centered intelligent systems.
